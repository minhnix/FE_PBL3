    ...
    return (
        ...
        <div style={{ display: "flex" }} >
            ...
            <div style={{ backgroundColor: "#1f1f1f", width: "100%", marginLeft: "220px", overflow: "hidden", minHeight: "100vh" }}>
                ...
                <Row className='m-4'>
                    <Col lg={12} className='p-4' style={{ display: "flex", justifyContent: "right" }}>
                        <span className='cart-box' data-value={"!"} style={{ borderRadius: "50%", backgroundColor: "#222e3c", border: "1px solid white", width: "50px", height: "50px", display: "grid", placeItems: "center", marginRight: "12px" }}>
                            <div style={{ fontSize: "24px", lineHeight: "20px" }}><BsBell style={{ color: "white" }}></BsBell ></div>
                        </span>
                    </Col>
                </Row>
                <Row className='faj-center' style={{ marginTop: "76px" }}>
                    <Col lg={10} >
                        <ul className='p-3' style={{ display: "flex", justifyContent: "space-around", alignItems: "center", backgroundColor: "#222e3c", color: "white", borderBottom: "1px solid white" }}>
                            ...
                            <li style={{ width: "120px", textAlign: "center" }}>Phone Number</li>
                        </ul>

                        {currentPosts?.map((item) => <OrderDetailItems type={'order'} data={item}></OrderDetailItems>)}
                        <PaginationControl
                            page={currentPage}
                            between={3}
                            total={temp.length}
