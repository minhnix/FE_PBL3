            ...
            <div style={{ backgroundColor: "#1f1f1f", width: "100%", marginLeft: "220px", overflow: "hidden", minHeight: "100vh" }}>
                ...
                <Row className='faj-center'>
                    <Col lg={10} >
                        ...
                        {currentPosts?.map((item) => <OrderDetailItems handleGetData={handleGetData} type={'manager'} handleGetAction={handleGetAction} handleSetShowStatus={handleSetShowStatus} data={item} object={"import"}></OrderDetailItems>)}
                        <PaginationControl
                            page={currentPage}
                            between={3}
                            total={temp.length}
                ...
                {showStatus && <ImportFormManager data={data} handleGetData={handleGetData} action={action} handleSetShowStatus={handleSetShowStatus} />}
            </div>
        </div >
